...
export type DecodedBolt11 = {
  ...
  expiryUnixSec: number | undefined;
...
export const decodeBolt11 = (invoice: string): DecodedBolt11 => {
  ...
  const amountMsat = amountSection?.value ? Number(amountSection.value) : undefined;
  ...
  let expiryUnixSec: number | undefined;
  ...
  return { amountMsat, amountSat, expiryUnixMs, expiryUnixSec, network, description, paymentHash };
};
